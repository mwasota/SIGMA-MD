...
global.timezone  = process.env.TIME_ZONE || 'Africa/Dodoma' // ADD CORRECT TIMEZONE OR LEAVE IT SAME , OTHERWISE YOU GET ERROS
//=================================================================================


//======================[YOUR CHOICE, CHANGE OR LEAVE IT SAME]=====================
global.sudo  =  process.env.SUDO || "255688930205" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"X♥︎❚❚♥︎S",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  botname: process.env.BOT_NAME       || 'Xhriss_Tech',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `Xhriss`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'xhrisstz',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "xhrisstz" ,          // ADD YOUR STICKER PACKNAME
  ...
  caption :process.env.CAPTION || "*Xhriss_Tech*",
  LANG: process.env.THEME || "XHRISS_MD",
